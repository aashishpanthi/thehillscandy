...
<html lang="en">
  <head>
    <title>Admin Login `The HillsCandy`</title>
    <meta charset="UTF-8" />
  ...
  <body>
    ...
    if(isset($_SESSION["adminLoginError"])){
      ?>
        <div class='error'><?php echo $_SESSION['adminLoginError']; ?></div>
      <?php
        ...
        <div class="wrap-login100 p-l-85 p-r-85 p-t-55 p-b-55">
          <form class="login100-form validate-form flex-sb flex-w" action='includes/login.php' method='post'>
            ...
            <div class="container-login100-form-btn">
              <button class="login100-form-btn" name='loginAdmin'>Login</button>
            </div>
          </form>
        </div>
      </div>
